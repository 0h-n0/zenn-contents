...
- [論文解説: A Survey of Agent Interoperability Protocols — MCP・ACP・A2A・ANPの比較分析](https://0h-n0.github.io/posts/paper-2505-02279/) - arXiv論文解説
- [Google Developers Blog解説: Agent2Agent (A2A) Protocol](https://0h-n0.github.io/posts/techblog-google-a2a-protocol/) - tech_blog解説
- [Anthropic公式ブログ解説: MCPの寄贈とAAIF設立](https://0h-n0.github.io/posts/techblog-anthropic-mcp-aaif/) - tech_blog解説
- [論文解説: MCP Safety Audit — MCPエコシステムのセキュリティ脅威評価](https://0h-n0.github.io/posts/paper-2504-03767/) - arXiv論文解説
- [AWS公式ブログ解説: Bedrock AgentCore RuntimeのA2Aプロトコルサポート](https://0h-n0.github.io/posts/techblog-aws-a2a-bedrock/) - tech_blog解説
