...
- [AWS公式ブログ解説: Secure AI agents with Policy in Amazon Bedrock AgentCore](https://0h-n0.github.io/posts/techblog-secure-ai-agents-bedrock-agentcore-policy/) - tech_blog解説
- [論文解説: Agentic AI for Enterprise - Multi-Agent Orchestration with Guardrails](https://0h-n0.github.io/posts/paper-2501-17822/) - arxiv解説
- [AWS公式ブログ解説: Multi-Agent collaboration patterns with Strands Agents and Amazon Nova](https://0h-n0.github.io/posts/techblog-multi-agent-strands-agents-amazon-nova/) - tech_blog解説
- [OOPSLA 2024論文解説: Cedar - A New Language for Authorization](https://0h-n0.github.io/posts/conf-cedar-policy-language-authorization/) - conference解説
- [論文解説: Authenticated Delegation and Authorized AI Agents](https://0h-n0.github.io/posts/paper-2501-10236/) - arxiv解説
