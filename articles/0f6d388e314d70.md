...
- [論文解説: 1-bit AI Infra — BitNet b1.58のCPU推論高速化](https://0h-n0.github.io/posts/paper-2408-03314/) - arxiv解説
- [論文解説: CQAP — 16-bitから1.58-bitへの最適移行戦略](https://0h-n0.github.io/posts/paper-2502-11895/) - arxiv解説
- [TENET: 三値LLM推論を21倍効率化するLUTアーキテクチャ](https://0h-n0.github.io/posts/techblog-tenet-ternary-lut/) - tech_blog解説
- [MSR解説: 低ビット量子化でエッジLLM推論を実現するT-MAC/LUT Tensor Core](https://0h-n0.github.io/posts/techblog-msr-lowbit-edge/) - tech_blog解説
- [論文解説: LLMの完全バイナリ化 — W(1+1)A(1×4) PTQ](https://0h-n0.github.io/posts/paper-2504-05352/) - arxiv解説
