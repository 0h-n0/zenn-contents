...
- [EMNLP 2024論文解説: CodeAgent — マルチエージェントLLMによる自律的コードレビューシステム](https://0h-n0.github.io/posts/conf-codeagent-autonomous-code-review/) - conference解説
- [論文解説: LLM4CR — RAGとイテレーティブリファインメントによるLLMベースコードレビュー自動化](https://0h-n0.github.io/posts/paper-2501-18099/) - arxiv解説
- [論文解説: Reasoning Language Models: A Blueprint — 推論言語モデル構築の体系的設計図](https://0h-n0.github.io/posts/paper-2502-04463/) - arxiv解説
- [Microsoft Research解説: CORE — LLMのProposer-Rankerで静的解析の指摘を自動修正](https://0h-n0.github.io/posts/techblog-microsoft-core-code-quality/) - tech_blog解説
- [NVIDIA解説: Teacher-Studentパラダイムで小規模LLMのコードレビュー精度を18%向上](https://0h-n0.github.io/posts/techblog-nvidia-fine-tuning-code-review/) - tech_blog解説
