...
本記事の内容をさらに深く理解するための1次情報記事です。

- [論文解説: An Analysis of Fusion Functions for Hybrid Retrieval [2210.11934]](https://0h-n0.github.io/posts/paper-2210-11934/) — RRF・線形結合・LTRの体系的比較
- [論文解説: RAG-Fusion — マルチクエリ生成×RRFでRAG検索の網羅性を向上 [2402.03367]](https://0h-n0.github.io/posts/paper-2402-03367/) — LLMクエリ拡張とRRFの組み合わせ
- [論文解説: Blended RAG — セマンティック×BM25×メタデータフィルタリング [2404.07220]](https://0h-n0.github.io/posts/paper-2404-07220/) — 3手法融合で検索精度84.6%達成
- [AWS公式ブログ解説: OpenSearch Serviceでスパース×デンスベクトルを統合したRAGハイブリッド検索](https://0h-n0.github.io/posts/techblog-opensearch-hybrid-rag/) — Neural Sparse Search + kNN実装
- [SIGIR 2009論文解説: Reciprocal Rank Fusion — ハイブリッド検索の基盤手法](https://0h-n0.github.io/posts/conf-reciprocal-rank-fusion/) — RRF原論文の詳細解説
