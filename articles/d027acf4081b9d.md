...
本記事に関連する1次情報（arXiv論文・企業テックブログ）の詳細解説記事です。

- [論文解説: Prompt Cache — Modular Attention Reuse (arXiv 2311.04934)](https://0h-n0.github.io/posts/paper-2311-04934/) — KVキャッシュの位置独立な再利用を実現するPosition-Aware Encoding手法
- [Anthropic解説: Claude APIプロンプトキャッシュ](https://0h-n0.github.io/posts/techblog-anthropic-prompt-caching-claude/) — Claude APIのキャッシュ料金体系と損益分岐分析
- [論文解説: FrugalGPT — LLMカスケードによるコスト最大98%削減 (arXiv 2305.05176)](https://0h-n0.github.io/posts/paper-2305-05176/) — 複数LLMの動的選択でAPIコストを最適化する手法
- [Care Access × Bedrock Prompt Caching 86%コスト削減事例](https://0h-n0.github.io/posts/techblog-aws-care-access-bedrock-caching/) — 医療記録処理での実プロダクション適用事例
- [論文解説: PyramidKV — KVキャッシュ12%でFull精度の99%を維持 (arXiv 2405.14256)](https://0h-n0.github.io/posts/paper-2405-14256/) — ピラミッド型KVキャッシュ圧縮による推論メモリ最適化
