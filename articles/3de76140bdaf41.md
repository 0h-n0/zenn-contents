...
- [論文解説: OpenFedLLM — 分散プライベートデータによるLLMの連合学習フレームワーク](https://0h-n0.github.io/posts/paper-2312-00517/) - arxiv解説
- [論文解説: FLoRA — LoRAアダプタは勾配圧縮器である](https://0h-n0.github.io/posts/paper-2402-06954/) - arxiv解説
- [論文解説: HetLoRA — 異種LoRA構成による連合LLMファインチューニング](https://0h-n0.github.io/posts/paper-2410-09009/) - arxiv解説
- [論文解説: FedKSeed — ゼロ次最適化による勾配不要の連合学習](https://0h-n0.github.io/posts/paper-2406-03588/) - arxiv解説
- [Google Research解説: ユーザーレベル差分プライバシーによるLLMファインチューニング](https://0h-n0.github.io/posts/techblog-google-dp-llm-finetuning/) - tech_blog解説
