...
本記事で扱ったトピックについて、1次情報（論文・企業テックブログ）をさらに深掘りした記事を公開しています。

| 種別 | タイトル | 情報源 |
|------|---------|--------|
| arXiv論文 | [論文解説: Prompt Injection Attacks and Defenses in LLM-Integrated Applications](https://0h-n0.github.io/posts/paper-2410-05451/) | [arXiv:2410.05451](https://arxiv.org/abs/2410.05451) |
| 企業テックブログ | [NVIDIA技術ブログ解説: Stored Prompt Injectionの脅威と5つの緩和戦略](https://0h-n0.github.io/posts/techblog-nvidia-stored-prompt-injection/) | [NVIDIA Developer Blog](https://developer.nvidia.com/blog/mitigating-stored-prompt-injection-attacks-against-llm-applications/) |
| カンファレンス論文 | [NAACL 2025論文解説: 間接プロンプトインジェクション防御を突破する適応的攻撃](https://0h-n0.github.io/posts/conf-naacl-adaptive-attacks-ipi/) | [arXiv:2503.00061](https://arxiv.org/abs/2503.00061) |
| カンファレンス論文 | [NAACL 2025論文解説: Attention Trackerによるプロンプトインジェクション検出](https://0h-n0.github.io/posts/conf-naacl-attention-tracker/) | [arXiv:2411.00348](https://arxiv.org/abs/2411.00348) |
| 企業テックブログ | [NVIDIA技術ブログ解説: LangChainの脆弱性3件とLLMセキュリティの教訓](https://0h-n0.github.io/posts/techblog-nvidia-securing-llm-langchain/) | [NVIDIA Developer Blog](https://developer.nvidia.com/blog/securing-llm-systems-against-prompt-injection/) |
