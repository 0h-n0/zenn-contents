...
この記事に関連する1次情報（論文・企業テックブログ）の深掘り記事です。

- [NeurIPS 2025論文解説: A-MEM — Zettelkasten手法によるLLMエージェント自律メモリ](https://0h-n0.github.io/posts/conf-amem-neurips2025/) — Zettelkasten知識管理手法をLLMエージェントのメモリに適用した構造化メモリフレームワーク
- [論文解説: MemEngine — LLMエージェントメモリの統一フレームワーク](https://0h-n0.github.io/posts/paper-2501-17893/) — Operations/Functions/Modelsの3層アーキテクチャによるメモリ管理の統一的理解
- [LangChainブログ解説: Memory for Agents](https://0h-n0.github.io/posts/techblog-langchain-memory-for-agents/) — Procedural/Semantic/Episodicの3類型とホットパス/バックグラウンド更新方式
- [Anthropicブログ解説: Effective Harnesses for Long-Running Agents](https://0h-n0.github.io/posts/techblog-anthropic-effective-harnesses-long-running-agents/) — Initializer/Coding Agent 2段構成による長時間稼働エージェントの状態管理
- [AWSブログ解説: Build Durable AI Agents with LangGraph and Amazon DynamoDB](https://0h-n0.github.io/posts/techblog-aws-langgraph-dynamodb-durable-agents/) — DynamoDBSaverの階層型ストレージ設計とTTLライフサイクル管理
