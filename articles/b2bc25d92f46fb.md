...
本記事の内容をさらに深掘りした1次情報記事を公開しています。

- [Azure APIM Unified AI Gatewayデザインパターン](https://0h-n0.github.io/posts/techblog-azure-apim-unified-ai-gateway/)（Microsoft Tech Community）
- [SemCache: LLMセマンティックキャッシュの精度問題と二段階検証](https://0h-n0.github.io/posts/paper-2502-03771/)（arXiv:2502.03771）
- [LLMアプリケーションにおけるリトライ・フォールバック・サーキットブレーカーの使い分け](https://0h-n0.github.io/posts/techblog-portkey-circuit-breakers-llm/)（Portkey.ai）
- [LLMトークン最適化: セマンティックキャッシュとプロンプト圧縮によるコスト・レイテンシ削減](https://0h-n0.github.io/posts/techblog-redis-llm-token-optimization/)（Redis）
- [RouterEval: LLMルーティング戦略の包括的ベンチマーク](https://0h-n0.github.io/posts/conf-emnlp2025-routereval/)（EMNLP 2025）
