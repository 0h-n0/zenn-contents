...
本記事で取り上げた技術・論文について、より詳細な解説記事を公開しています。

- [論文解説: AlphaFold3 — 生体分子間相互作用の汎用構造予測](https://0h-n0.github.io/blog/paper/arxiv/2026/03/04/paper-alphafold3-biomolecular-interactions/) — Nature 2024掲載、Pairformer＋拡散モジュールによるタンパク質・核酸・リガンド複合体の統合予測手法を解説
- [技術ブログ解説: IsoDDE — Isomorphic Labs Drug Design Engine](https://0h-n0.github.io/blog/techblog/isomorphic/2026/03/04/techblog-isodde-drug-design/) — AlphaFold3比2倍以上の精度を達成したIsoDDEの技術的詳細と創薬への応用
- [ICML 2025 論文解説: GenMol — 離散拡散モデルによる分子生成](https://0h-n0.github.io/blog/conference/icml/2026/03/04/conf-icml2025-genmol-discrete-diffusion/) — NVIDIAによるSAFE表記＋離散拡散を組み合わせた新しい分子生成フレームワーク
- [論文解説: FlowDock — フローマッチングによるタンパク質-リガンドドッキング](https://0h-n0.github.io/blog/paper/arxiv/2026/03/04/paper-2412-10966/) — SE(3)-等変フローマッチングを用いたブラインドドッキング手法、CASP16で評価
- [論文解説: 拡散モデルによるDe Novo創薬 — 手法の体系的レビュー](https://0h-n0.github.io/blog/paper/arxiv/2026/03/04/paper-2406-08511/) — DDPM・スコアベース・フローマッチングなど拡散モデルの創薬応用を体系的に整理
