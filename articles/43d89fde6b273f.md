...
```python
GRADER_MODELS = {
    "retrieval_decision": "claude-haiku-4-5-20251001",  # 単純なyes/no
    "relevance_grade": "claude-haiku-4-5-20251001",     # キーワード+意味判断
    "support_grade": "claude-sonnet-4-6",      # 複雑な根拠検証
    "usefulness_grade": "claude-sonnet-4-6",   # 品質の総合判断
}
```
