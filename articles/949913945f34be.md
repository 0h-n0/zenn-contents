...
# 注: AnthropicのClaude利用はAmazon Bedrock経由（直接のAnthropicバックエンドは未対応）
...
Gartnerは2025年8月のレポートで、「2026年までにエンタープライズアプリケーションの40%にタスク固有のAIエージェントが組み込まれる」と予測しています（2025年時点では5%未満）。また別の予測では、2028年までにエンタープライズソフトウェアの33%にエージェントAIが組み込まれ、日常業務の判断の15%が自律的に実行されるようになるとしています。
...
**トレードオフ:**
> AIコーディングエージェントの採用率は15.85〜22.60%（129,134プロジェクトを対象としたGitHub大規模調査、arXiv:2601.18341、2025年）と報告されています。これは急速に拡大していますが、完全自動化にはまだ距離があります。特に、ドメイン固有のビジネスロジック、セキュリティ要件、法規制対応など、コンテキスト依存の判断が必要な領域では人間の関与が不可欠です。
...
- [Agentic Much? Adoption of Coding Agents on GitHub (arXiv:2601.18341)](https://arxiv.org/abs/2601.18341)
...
- [EvoAgent: 継続的探索によるエージェント自己進化](https://0h-n0.github.io/posts/paper-2503-00237/) - arxiv解説
- [Kubernetes自律エージェント会話型インターフェース](https://0h-n0.github.io/posts/paper-2503-09194/) - arxiv解説
- [NVIDIA NVSentinel: GPU自己修復システム](https://0h-n0.github.io/posts/techblog-nvidia-nvsentinel/) - tech_blog解説
- [AI駆動自己修復ネットワーク制御プレーン](https://0h-n0.github.io/posts/paper-2504-01848/) - arxiv解説
- [OpenAI Self-Evolving Agents: 自律的プロンプト最適化](https://0h-n0.github.io/posts/techblog-openai-self-evolving-agents/) - tech_blog解説
