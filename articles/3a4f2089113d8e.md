...
本記事で扱ったトピックの1次情報（arXiv論文・企業テックブログ）を深掘りした記事です。

| タイトル | 情報源 | 内容 |
|---------|--------|------|
| [DeepSeek-V3 Technical Report](https://0h-n0.github.io/posts/paper-2412-19437/) | arXiv 2412.19437 | MLA・DeepSeekMoE・FP8学習の技術詳細 |
| [MetaLLM: Dynamic LLM Router](https://0h-n0.github.io/posts/paper-2406-12320/) | arXiv 2406.12320 | Multi-Armed Banditによるコスト最適LLMルーティング |
| [JOrthoBench: 日本語表記揺れ評価](https://0h-n0.github.io/posts/paper-2501-15238/) | arXiv 2501.15238 | 6種類の表記揺れに対するLLM頑健性評価 |
| [NVIDIA MoE解説: フロンティアモデルの仕組み](https://0h-n0.github.io/posts/techblog-nvidia-moe-frontier/) | NVIDIA Blog | Expert Parallelism・Blackwell NVL72最適化 |
| [Gemma-2-Llama Swallow](https://0h-n0.github.io/posts/techblog-deepmind-gemma-swallow/) | DeepMind/Swallow | 27Bで70Bクラスの日本語性能を実現 |
