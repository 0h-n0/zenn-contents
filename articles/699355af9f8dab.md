...
- **MTTR（平均復旧時間）**: 40〜67%短縮（Forrester調査で67%短縮、HCL Technologies事例で33%短縮など、導入企業により幅がある）
- **インシデント対応速度**: PagerDuty AI Suite導入企業で50%改善（[PagerDuty 2025年10月発表](https://www.pagerduty.com/blog/product/product-launch-2025-h2/)）
- **導入率**: 大企業の60%以上がself-healing infrastructureを採用（[Gartner予測](https://byteiota.com/aiops-self-healing-60-enterprises-adopt-in-2026/)）
...
**制約条件:** この転換は段階的に進みます。Gartnerは2029年までにIT基盤運用の70%にAgentic AIが導入されると予測していますが（[Gartner 2025年8月](https://www.gartner.com/en/newsroom/press-releases/2025-08-26-gartner-predicts-40-percent-of-enterprise-apps-will-feature-task-specific-ai-agents-by-2026-up-from-less-than-5-percent-in-2025)）、2026年時点ではまだ初期段階です。未知の障害パターン、ビジネス判断を伴う意思決定、規制対応等は当面人間が担当し続ける必要があります。
...
本記事に関連するarXiv論文・企業テックブログの深掘り記事を公開しています。

| # | タイプ | タイトル | リンク |
|---|--------|--------|-------|
| 1 | arXiv | SRE-Agent: LLMマルチエージェントSREフレームワーク (2503.00455) | [記事を読む](https://0h-n0.github.io/posts/paper-2503-00455/) |
| 2 | arXiv | Multi-Agent Self-Healing: 4層階層型自己修復システム (2411.04536) | [記事を読む](https://0h-n0.github.io/posts/paper-2411-04536/) |
| 3 | arXiv | ARES: IBM Researchインシデント自動対応 (2410.17033) | [記事を読む](https://0h-n0.github.io/posts/paper-2410-17033/) |
| 4 | tech_blog | Microsoft Research AIOpsLab: AIOps評価フレームワーク | [記事を読む](https://0h-n0.github.io/posts/techblog-aiopslab/) |
| 5 | tech_blog | AWS Bedrock AgentCore SREエージェント | [記事を読む](https://0h-n0.github.io/posts/techblog-aws-bedrock-sre/) |
